...
# Contributing to FileRune

Thanks for your interest in contributing!

This is a guideline for contributing to FileRune.
...
| ---------------------------------------------- | -------------------------------------- |
| [Node.js](https://nodejs.org/en) 20            | JavaScript runtime                     |
...
This command will run all benchmarks.

```sh
just bench
```

Or run client/server benchmarks separately.
...
This command will clean all generated media files.
